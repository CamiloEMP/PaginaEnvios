        ...
        <Formik
          ...
          validate={(values) => {
            ...
            if (!values.PackageDimensionsAncho) {
              ...
              errores.PackageDimensionsAncho =
              ...
              errores.PackageDimensionsLargo =
                "Solo se admiten valores numéricos";
            }
            ...
            if (!values.NombreRecibe) {
              errores.NombreRecibe =
                "Ingrese el nombre de la persona que recibe el paquete ";
            ...
            if (
              values.weightP &&
              values.PackageDimensionsAncho &&
              values.PackageDimensionsAlto &&
              values.PackageDimensionsLargo &&
              values.valorDeclarado
            ) {
              if (volumen > 216000 && peso > 3) {
                values.CostoEnvio = Math.round(
                  8500 + volumen * 0.02 + peso * 0.7
                );
                values.ValorSeguro = Math.round(
                  values.CostoEnvio * 0.1 + values.valorDeclarado * 0.05
                );
              } else {
                values.CostoEnvio = 8500;
                values.ValorSeguro = Math.round(values.CostoEnvio * 0.1);
              }
            }
          ...
          {({ errors, values }) => (
            <Form className="information">
              <div>
                ...
                <Field
                  type="text"
                  id="PackageDimensionsAncho"
                  name="PackageDimensionsAncho"
                  className="inputDimensiones"
                ></Field>
                <label> Alto </label>{" "}
                <Field
                  type="text"
                  id="PackageDimensionsAlto"
                  name="PackageDimensionsAlto"
                  className="inputDimensiones"
                ></Field>
                <label> Largo </label>{" "}
                <Field
                  type="text"
                  id="PackageDimensionsLargo"
                  name="PackageDimensionsLargo"
                  className="inputDimensiones"
                ></Field>
                <ErrorMessage
                  name="PackageDimensionsAncho"
                  component={() => (
                    <p className="ErrorPR">){errors.PackageDimensionsAncho}</p>
                  )}
                />
                <ErrorMessage
                  name="PackageDimensionsAlto"
                  component={() => (
                    <p className="ErrorPR">){errors.PackageDimensionsAlto}</p>
                  )}
                />
                <ErrorMessage
                  name="PackageDimensionsLargo"
                  component={() => (
                    <p className="ErrorPR">){errors.PackageDimensionsLargo}</p>
                  )}
                />
              </div>
              ...
              <div>
                ...
                <ErrorMessage
                  name="weightP"
                  component={() => <p className="ErrorPR">){errors.weightP}</p>}
                />
              </div>
              ...
              <div>
                ...
                <ErrorMessage
                  name="valorDeclarado"
                  component={() => (
                    <p className="ErrorPR">){errors.valorDeclarado}</p>
                  )}
                />
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <option value="SanJosedelGuaviare">
              ...
              <div>
                ...
                <ErrorMessage
                  name="DireccionEnvio"
                  component={() => (
                    <p className="ErrorPR">){errors.DireccionEnvio}</p>
                  )}
                />
              </div>
              ...
              <div>
                ...
                <ErrorMessage
                  name="NombreRecibe"
                  component={() => (
                    <p className="ErrorPR">){errors.NombreRecibe}</p>
                  )}
                />
              </div>
              ...
              <div>
                <Field
                  ...
                  placeholder="Ingrese una breve descripción del contenido del paquete (Opcional)"
                ></Field>
              </div>
              ...
              {guiaGenerada && (
                <p className="exitoPR">
                  Tu paquete ahora será trasnportado por uno de nuestros
                  operadores Delivery Xpress
                </p>
              )}
            </Form>
          )}
